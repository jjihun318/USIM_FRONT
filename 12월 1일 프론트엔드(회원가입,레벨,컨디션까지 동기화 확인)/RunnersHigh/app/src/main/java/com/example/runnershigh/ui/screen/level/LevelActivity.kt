...
class LevelActivity : AppCompatActivity(), CoroutineScope { // 파일명과 클래스명 변경됨
    ...
    private fun loadDummyData() {
        // 1. 더미 레벨 데이터
        val dummyLevel = UserLevel(level = 4, currentXp = 780, nextLevelXp = EXP_PER_LEVEL, progress = 0.78, userId = "123") // Lv 4, 780 EXP
        updateLevelUI(dummyLevel)

        // 2. 더미 컨디션 데이터
        val dummyCondition = UserCondition(todayStatus = "매우 좋음", todayScore = 90)
