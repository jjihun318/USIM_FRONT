...
fun RunningStatsOverlayRoute(
    ...
    val targetDistanceKm = compare?.targetDistanceKm
        ?.takeIf { it > 0 }
        ?: planGoal.targetDistanceKm.takeIf { it > 0 }
        ?: distanceKm

    val targetPaceSec = compare?.targetPaceSec ?: planGoal.targetPaceSecPerKm ?: 0
    val currentPaceSec = if (distanceKm > 0) {
